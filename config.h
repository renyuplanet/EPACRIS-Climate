...
#define FREEZE_CLOUD_AFTER_NMAX_RC 0
...
#define IMODE       2   /*  0: Calculate initial concentrations from chemical equilibrium sub-routines (not rad);
                        ...
                        */
#define IMODE_CHEM_FILE "Results/K2-18b/ConcentrationSTD_NMAX_1_cp.dat"
...
#define REACTION_LIST   "Library/ReactionList/zone_general_CHO.dat" // Reaction List
//--------------------------------------------------------------------- 
...
#define TPLIST      "Results/K2-18b/frozen_2iters_TP.dat"
